ninja.translator = {
	...
	translations: {
		"en": {
			...
			"brainalertpassphrasewarning": "Warning: Choosing a strong passphrase is important to avoid brute force attempts to guess your passphrase and steal your bitcoins. Use <a href=\"http://world.std.com/~reinhold/diceware.html\">Diceware</a> to generate truly random passphrases.",
		...
		"es": {
			...
			"brainalertpassphrasewarning": "Aviso: Es importante escoger una contraseña fuerte para evitar ataques de fuerza bruta a fin de adivinarla y robar tus bitcoins. Utilice <a href=\"http://world.std.com/~reinhold/diceware_en_espanolA.htm\">Diceware</a> para generar contraseñas realmente aleatorios.",
		...
		"fr": {
			...
			"brainalertpassphrasewarning": "Attention: Choisir un mot de passe solide est important pour vous protéger des attaques bruteforce visant à trouver votre mot de passe et voler vos Bitcoins. Utilisez <a href=\"http://world.std.com/~reinhold/diceware.html\">Diceware</a> pour générer des phrases de passe vraiment aléatoires.",
		...
		"el": {
			...
			"brainalertpassphrasewarning": "Προσοχή: Είναι σημαντικό να επιλέξετε μια ισχυρή φράση κωδικό που θα σας προφυλάξει από απόπειρες παραβίασής της τύπου brute force και κλοπή των bitcoins σας. Χρησιμοποιήστε <a href=\"http://world.std.com/~reinhold/diceware.html\">Diceware</a> για να δημιουργήσει πραγματικά τυχαίους συνθηματικές φράσεις.",
	    ...
	    "it": {
			...
			"brainalertpassphrasewarning":"Attenzione: La scelta di una passphrase robusta è importante per evitare attacchi brute force in grado di indovinare la tua passphrase e rubare i tuoi Bitcoin. Utilizzare <a href=\"http://world.std.com/~reinhold/diceware.html\">Diceware</a> per generare passphrase veramente casuali.",
	    ...
	    "de": {
			...
			"brainalertpassphrasewarning": "Hinweis: Eine längere Passphrase schützt besser vor Brute-Force-Attacken, bei denen auf gut Glück Passphrasen probiert werden. Verwenden Sie <a href=\"http://world.std.com/~reinhold/diceware.html\">Diceware</a>, um wirklich zufällige Passwörter generieren.",
		...
		"cs": {
			...
			"brainalertpassphrasewarning": "Varování: Je důležité zvolit silné heslo, které je odolné proti útoku hrubou silou a krádeži vašich Bitcoinů. Použijte <a href=\"http://world.std.com/~reinhold/diceware.html\"> Diceware </ a> pro generování skutečně náhodných přístupových frází.",
